...
export default function AboutCard() {
  ...
  return (
    <Grid container direction="row-reverse" className={classes.root} xs={12} spacing={2}>
      <Grid item xs={12} lg={7}>
        <Typography variant="h5" component="h5" className={classes.title}>
          درباره موسسه خیرین مدرسه ساز خوزستان
        </Typography>
        <Typography style={{textAlign: "right",lineHeight:"40px",color: "#64676C",fontSize:"1.2rem",marginBlock:20}} >
        ...
        <Typography style={{textAlign: "right",lineHeight:"40px",color: "#64676C",fontSize:"1.2rem"}} >
        ...
        <button className="btn1" style={{marginRight: 0,marginTop:20,padding: "10px 30px"}}>بیشتر بدانید</button>
      </Grid>
      <Grid item md={5}>
        <Hidden mdDown="true" >
