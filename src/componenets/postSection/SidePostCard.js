        ...
        <Card className= {classes.root + ' side-news-card'}>
            <CardActionArea className= {classes.root + ' side-news-card'}>
                <CardMedia 
                    ...
                    image={sideData.imageIds[0] ? `http://charity.mykanoon.ir/File/Get/${sideData.imageIds[0]}` : Picture}
                    title="Side-News"
                />
                <CardContent className={classes.content + ' side-news-content'}>
                    <Typography className='side-content__item' variant="body1" component="h6">
                        {sideData.title}
                    </Typography>
                </CardContent>
